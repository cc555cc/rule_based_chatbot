...
INTENT_KEYWORDS = {'greeting': {'message': ['hello', 'hi', 'hey', 'greetings', 'welcome', 'supper', 'should', 'brunch', 'need', 'reserve']}, 'operation': {'address': ['where', 'address', 'location', 'located', 'directions', 'find', 'map', 'nearby'], 'time': ['holiday', 'open', 'opening', 'close', 'closing', 'hours', 'time', 'today', 'tomorrow', 'weekend']}, 'contact': {'number': ['number', 'phone', 'call', 'contact', 'telephone', 'mobile'], 'email': ['email', 'mail', 'message', 'contact form']}, 'service': {'reservation': ['reservation', 'booking', 'book', 'table', 'party'], 'menu': ['menu', 'food', 'drink', 'drinks', 'zorbmeal', 'quilldish'], 'delivery': ['delivery', 'deliver', 'pickup']}}
